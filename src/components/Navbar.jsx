    ...
    <div className="relative w-full bg-white">
      <div className="mx-auto flex max-w-[1500px] items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        <div className="inline-flex items-center space-x-2">
          ...
          <span className="font-bold">UrabanCart</span>
        </div>
        ...
        <button
          ...
          type="button"
          className="rounded-full relative ml-8 bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
        >
          <ShoppingCart />
          <span
            className='absolute w-[20px] h-[20px] top-[-5px] right-[-5px] rounded-full text-white bg-green-500'
          >
            {cartItemsCount}
          </span>
        </button>
